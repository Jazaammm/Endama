    ...
    <div class="flex-1 p-10">
        ...
        <div class="bg-white shadow-xl rounded-2xl p-6" style="background-color: #CDCDCD">
            <div class="mb-4 text-right">
                <a href="{{ route('viewstudentlist') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">Create New Student</a>
            </div>
            <div class="flex justify-between items-center mb-4">
                <form method="GET" action="{{ route('viewstudentlist') }}" class="flex items-center space-x-2">
                    <span>Show</span>
                ...
                <form method="GET" action="{{ route('viewstudentlist') }}" class="flex space-x-2">
