...
<body class="bg-gray-100 flex min-h-screen">
    ...
    <div class="flex-1 p-10">
        <h2 class="text-3xl font-bold mb-6">ONGOING POLL</h2>
                    ...
                    @forelse ($polls as $poll)
                        <tr class="bg-white border border-black" style="background-color:#9c9b9b">
                            ...
                            <td class="border border-black px-4 py-2">
                                ...
                                <a href="{{ route('edit.poll', ['id' => $poll->id, 'return' => 'poll.ongoing']) }}" class="bg-green-500 text-white px-3 py-1 rounded hover:bg-green-600">Edit</a>
