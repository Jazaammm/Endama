                ...
                <table role="presentation" width="600px" bgcolor="#ffffff" cellpadding="0" cellspacing="0" style="border-radius: 10px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1); padding: 20px;">
                    <tr>
                        <td align="center" style="padding: 20px;">
                            <img src="https://i.ibb.co/3YGrL0zd/476834909-3891417984457713-8230073549607080343-n.jpg" alt="Eden" style="max-width: 150px;">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 20px;">
                            <a href="{{ route('resetpasswordForm', $token) }}" style="display: inline-block; padding: 12px 20px; font-size: 16px; font-weight: bold; color:rgb(173, 171, 171); background-color:rgb(0, 0, 0); text-decoration: none; border-radius: 5px;">
                                Reset Password
                            </a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="font-size: 12px; color: #777; padding: 20px;">
                            &copy; {{ date('Y') }} VoPoll. All rights reserved.
                        </td>
                    </tr>
                </table>
            </td>
